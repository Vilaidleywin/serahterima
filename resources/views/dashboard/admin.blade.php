...
@push('styles')
    <style>
        ...
        .head { color: var(--ink); font-weight: 800; }
        ...
        .tile .v { font-size: 2rem; font-weight: 800; }
        .tile .l { font-weight: 700; }

        .tile.navy { background: var(--primary); }
        .tile.green { background: var(--success); }
        .tile.slate { background: var(--neutral); }
        .tile.amber { background: #fde68a; color: #1f2937; }
                    ...
                    <table class="table table-clean table-sm mb-0">
                        ...
                        <tbody>
                            @forelse($latestUsers as $i => $u)
                                @php
                                    $role = $u->role ?? 'user';
                                    $on   = $u->is_active_view ? true : false;
                                @endphp
                                <tr>
